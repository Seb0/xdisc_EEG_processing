...
% analysis_dir =  [project_dir 'analysis\' 'mod_x_n1\' 'BC\' 'all_trials'];  
% analysis_dir = [project_dir 'analysis\' 'pwr_graph_corr_vs_incorr\' 'BC\']
grpdir=['group_sel_' num2str(length(gsubjects)) '\'];
contrasts={'01';'02';'03';'04';'05'} %;'03';'04';'05';'06';'07';'08';'09';'10'};

D=spm_eeg_load(fullfile(project_dir, 'processed_data', 'subj02',['sqrt_mtf_fraeMMMfxdisc' gsubjects{1} '.mat'])); %just load the chanlabels once
Elecs = D.chanlabels;
indir=[analysis_dir,'\'];

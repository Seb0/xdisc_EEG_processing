...
contrasts={'01','02','03', '04', '05', '06', '07', '08', '09', '10', '11', '12', '13', '14', '15', '16', '17'};


D=spm_eeg_load(fullfile(project_dir, 'processed_data', 'subj02',['rmtf_fraeMMMfxdisc' gsubjects{1} '.mat'])); %just load the chanlabels once
Elecs = D.chanlabels;
indir=[analysis_dir,'\'];

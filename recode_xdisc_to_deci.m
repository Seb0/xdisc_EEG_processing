...
%         tmp(i+nj+1).value=tmp(i).value.*100000+param(1)*10000+param(2)*1000+param(3)*100+perf*10+button;
        tmp(i+nj+1).value=tmp(i).value.*100+perf*10+button; %recode to mod x perf x button
%         tmp(i+nj+1).value=tmp(i).value.*10000+param(1)*1000+param(2)*100+param(3)*10+perf; %recode to mod x numerosity

        nevt(i)=tmp(i+nj+1).value;
